...
function SetAvatar() {
  ...
  const debouncedSetProfilePicture = handleDebounce(setProfilePicture, 500);
    ...
    <>
      {isloading ? (
        ...
        <Container>
          ...
          <button className="submitButton" onClick={debouncedSetProfilePicture}>
            Set as Profile Picture (double click firsy time)
          </button>
        </Container>
      )}
      <ToastContainer />
